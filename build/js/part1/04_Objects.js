...
const greetGuitarist = (guitarist) => {
    ...
    if (guitarist.name) { //guitarist 객체에 name 속성이 존재하는지 확인
        return `Hello ${(_a = guitarist.name) === null || _a === void 0 ? void 0 : _a.toUpperCase()}!`; //guitarist 객체에 name 속성이 존재할 경우, 해당 이름을 대문자로 변환한 후, Hello [이름]! 형식의 문자열을 반환. 여기서 ?.는 옵셔널 체이닝 연산자로, guitarist.name이 undefined 또는 null인 경우를 대비하여 안전하게 접근.
    }
    return 'Hello!';
};
